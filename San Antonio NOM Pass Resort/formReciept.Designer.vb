...
Partial Class formReciept
    ...
    Private Sub InitializeComponent()
        ...
        Label2.Font = New Font("Consolas", 20.25F, FontStyle.Bold)
        ...
        ' txtGuestsName
        ' 
        txtGuestsName.BackColor = Color.AliceBlue
        ...
        ' txtNumberOfGuest
        ' 
        txtNumberOfGuest.BackColor = Color.AliceBlue
        ...
        ' txtArrivalDate
        ' 
        txtArrivalDate.BackColor = Color.AliceBlue
        ...
        ' txtDepartureDate
        ' 
        txtDepartureDate.BackColor = Color.AliceBlue
        ...
        ' txtTotalPayment
        ' 
        txtTotalPayment.BackColor = Color.AliceBlue
        ...
        btnConfirm.Location = New Point(55, 317)
        btnConfirm.Margin = New Padding(3, 2, 3, 2)
        btnConfirm.Name = "btnConfirm"
        btnConfirm.Size = New Size(108, 33)
        ...
        ' btnAddRoom
        ' 
        btnAddRoom.BackColor = Color.SteelBlue
        btnAddRoom.ForeColor = Color.White
        btnAddRoom.Location = New Point(188, 317)
        btnAddRoom.Margin = New Padding(3, 2, 3, 2)
        btnAddRoom.Name = "btnAddRoom"
        btnAddRoom.Size = New Size(108, 33)
        ...
        BackgroundImage = My.Resources.Resources.Desktop___2__2_
